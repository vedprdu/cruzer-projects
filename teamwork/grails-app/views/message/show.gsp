            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="message.title.label" default="Title" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: messageInstance, field: "title")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="message.detail.label" default="Detail" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: messageInstance, field: "detail")}</td>
