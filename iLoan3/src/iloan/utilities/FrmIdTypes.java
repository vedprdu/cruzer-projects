 ...
 * @author mrogers
 */
public class FrmIdTypes extends javax.swing.JInternalFrame
{
    ...
    private void populateLists()
    {
        ...
        tblSalutation.setModel(IDTypeList.getIDTypeTable());
    ...
    private void initComponents() {
        ...
        tblSalutation.setColumnSelectionAllowed(true);
    ...
    {//GEN-HEADEREND:event_cmdDisableActionPerformed
        if (tblSalutation.getSelectedRow() != -1)
        {
            ...
            if (response == JOptionPane.YES_OPTION)
            {
                ...
                {
                    String id = tblSalutation.getValueAt(rowID, 0).toString();
                    IDTypeList.disableIDType(id);
                }
                populateLists();
            }
        }
    ...
    {//GEN-HEADEREND:event_cmdAddActionPerformed
        String name = JOptionPane.showInputDialog("ID Type");
        if (name == null)
        {
            return;
        }
        ...
        int result = IDTypeList.addIDType(name);
        String message = "";
        switch (result)
        {
            case -1:
